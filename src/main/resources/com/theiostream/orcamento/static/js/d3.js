!function() {
  ...
  d3.behavior.zoom = function() {
    var view = {
      ...
      y: 0,
      k: 1
    }, xExtent=d3_behavior_scaleInfinity, yExtent=d3_behavior_scaleInfinity, translate0, center0, center, size = [ 960, 500 ], scaleExtent = d3_behavior_zoomInfinity, duration = 250, zooming = 0, mousedown = "mousedown.zoom", mousemove = "mousemove.zoom", mouseup = "mouseup.zoom", mousewheelTimer, touchstart = "touchstart.zoom", touchtime, event = d3_eventDispatch(zoom, "zoomstart", "zoom", "zoomend"), x0, x1, y0, y1;
